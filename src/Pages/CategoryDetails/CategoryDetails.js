...
const CategoryDetails = ({ course }) => {
  ...
  const { title, details, total_view, author, image_url, price, category_id } =
    course;
  console.log(course);
  return (
    <div className="">
      <div class=" my-5 font-serif dark:text-black bg-gradient-to-br from-green-200 via-lime-200 to-green-400 w-full max-w-sm  rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="px-5 pb-5">
          ...
          <div class="flex justify-between items-center">
            ...
            <button
              type="button"
              class="text-gray-900 bg-gradient-to-r from-lime-900 via-lime-300 to-lime-900 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center shadow-xl mr-2 mb-2"
            >
              {" "}
              <Link className="flex" to={`/courses/${course._id}`}>
                Premium Access
